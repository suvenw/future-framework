...
public class TopStringUtils {
	...
	public static void setValueIfNotBlank(String target, String source) {
		if (ObjectTrue.isNotEmpty(source)){
			target = source;
		}
	}
...
//	}
	...
	public static String toStringBuilder(String... params){
		StringBuilder sb = new StringBuilder();
	...
	public static String toIntegerBuilder(Integer params,Integer params2,Integer params3){
		StringBuilder sb = new StringBuilder();
		sb.append(params).append(Splitable.ATTRIBUTE_SPLIT);
		sb.append(params2).append(Splitable.ATTRIBUTE_SPLIT);
		sb.append(params3).append(Splitable.ATTRIBUTE_SPLIT);
		return sb.toString();
