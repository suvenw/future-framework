...
public class ImageProcess {
    // 存放所有下载验证码的目录
    private static final String DOWNLOAD_DIR = "/Users/suven/project/";

    // 存放已经拆分开的单个数字图片的目录，供比对用
    private static final String TRAIN_DIR = "/Users/suven/project/";

    // 存放比对结果的目录（重新以验证码所含数字命名文件，非常直观）
    private static final String RESULT_DIR = "/Users/suven/project/";
...
//    }
    ...
    private void downloadImage() throws Exception {
        ...
        for (int i = 0; i < 4; i++) {
            String url = "https://passport.baidu.com/cgi-bin/genimage?njGc906f524a36ae2a3023a15065b01508984a4de06f7011488";
