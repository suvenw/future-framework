...
public class NumberUtil {
	 ...
	 *            分割符
	 * @param clazz
	 *            要转换类型的类,如:Integer.class,Long.class
	 * @return T[] 返回class类型的数组
	 */
	public static <T> T[] convertArray(String str, String separator,
			Class<T> clazz) {
...
////		NumberUtil.delimiterString2Map2("12345_1|null", Long.class, Integer.class);
//		int i16 = Integer.parseInt("4E",16);
//		String i10 = Integer.toHexString(i16);
