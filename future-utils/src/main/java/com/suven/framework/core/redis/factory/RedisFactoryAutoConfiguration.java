...
public class RedisFactoryAutoConfiguration {
   ...
   private RedisClientModelType redisModelType;
    ...
    public RedisConnectionFactory redisConnectionFactory() {
       return new RedisConnectionStrategyFactory(redisConfig).createConnectionFactory();
    }
...
//        objectMapper.setDefaultTyping(objectMapper.getPolymorphicTypeValidator(), ObjectMapper.DefaultTyping.NON_FINAL);
