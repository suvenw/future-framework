...
public class VersionHandlerInterceptor  extends AbstractHandlerInterceptorAdapter implements IHandlerInterceptor {

    private static Logger log = LoggerFactory.getLogger(UrlWhiteHandlerInterceptor.class);

    public VersionHandlerInterceptor(ApplicationContext application, InterceptorConfigSetting handlerSetting) {
    ...
    @Override
    public int getOrder() {
        return HandlerInterceptorEnum.HANDEL_ORDER_VERSION.getIndex();
    }
