 ...
 *    修改后版本:     修改人：  修改日期:     修改内容:
 * </pre>
 * Description: (说明) http 接口统一json请求方法实现转换逻辑实现业务类;
 */

public class RequestJsonHandlerArgumentResolver extends AbstractHandlerArgumentResolver<HttpJsonRequest> {
    ...
    public Object parserDate(HttpServletRequest webRequest, HttpServletResponse response, Class<?> clazz, HttpRequestTypeEnum httpRequestTypeEnum) {
        return this.parseJsonData(webRequest,response,clazz,httpRequestTypeEnum);
    }
}