...
@Slf4j
public class DirectoryHandlerInterceptor extends AbstractHandlerInterceptorAdapter implements IHandlerInterceptor {

	private static Logger logger = LoggerFactory.getLogger(DirectoryHandlerInterceptor.class);


	private static ImmutableSet<String> ALLOWED_URL_PARAM = ImmutableSet.of("/","/test","/error");

	public DirectoryHandlerInterceptor(ApplicationContext application, InterceptorConfigSetting handlerSetting) {
