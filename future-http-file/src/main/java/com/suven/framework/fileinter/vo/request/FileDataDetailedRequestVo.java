...
public class FileDataDetailedRequestVo extends HttpRequestByIdPageVo{
    ...
    public static FileDataDetailedRequestVo build(){
        return new FileDataDetailedRequestVo();
    }




 		public FileDataDetailedRequestVo toAppId( String appId){
 		 		this.appId = appId ; 
 		 		 return this ;
 		}

 		public FileDataDetailedRequestVo toAppName( String appName){
 		 		this.appName = appName ; 
 		 		 return this ;
 		}

 		public FileDataDetailedRequestVo toClientId( long clientId){
 		 		this.clientId = clientId ; 
 		 		 return this ;
 		}

 		public FileDataDetailedRequestVo toCompanyId( String companyId){
 		 		this.companyId = companyId ; 
 		 		 return this ;
 		}

 		public FileDataDetailedRequestVo toCompanyName( String companyName){
 		 		this.companyName = companyName ; 
 		 		 return this ;
 		}

 		public FileDataDetailedRequestVo toFileProductName( String fileProductName){
 		 		this.fileProductName = fileProductName ; 
 		 		 return this ;
 		}

 		public FileDataDetailedRequestVo toFileBusinessName( String fileBusinessName){
 		 		this.fileBusinessName = fileBusinessName ; 
 		 		 return this ;
 		}

 		public FileDataDetailedRequestVo toUseBusinessId( long useBusinessId){
 		 		this.useBusinessId = useBusinessId ; 
 		 		 return this ;
 		}

 		public FileDataDetailedRequestVo toStorageConfigId( String storageConfigId){
 		 		this.storageConfigId = storageConfigId ; 
 		 		 return this ;
 		}

 		public FileDataDetailedRequestVo toFileSourceName( String fileSourceName){
 		 		this.fileSourceName = fileSourceName ; 
 		 		 return this ;
 		}

 		public FileDataDetailedRequestVo toFileType( String fileType){
 		 		this.fileType = fileType ; 
 		 		 return this ;
 		}

 		public FileDataDetailedRequestVo toErrorCode( String errorCode){
 		 		this.errorCode = errorCode ; 
 		 		 return this ;
 		}

 		public FileDataDetailedRequestVo toErrorMessage( String errorMessage){
