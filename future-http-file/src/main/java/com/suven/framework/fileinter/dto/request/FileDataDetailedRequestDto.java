...
public class FileDataDetailedRequestDto extends BaseTenantEntity implements Serializable{
        ...
        public static FileDataDetailedRequestDto build(){
            return new FileDataDetailedRequestDto();
        }


 		public FileDataDetailedRequestDto toAppId( String appId){
 		 		this.appId = appId ; 
 		 		 return this ;
 		}

 		public FileDataDetailedRequestDto toAppName( String appName){
 		 		this.appName = appName ; 
 		 		 return this ;
 		}

 		public FileDataDetailedRequestDto toClientId( long clientId){
 		 		this.clientId = clientId ; 
 		 		 return this ;
 		}

 		public FileDataDetailedRequestDto toCompanyId( String companyId){
 		 		this.companyId = companyId ; 
 		 		 return this ;
 		}

 		public FileDataDetailedRequestDto toCompanyName( String companyName){
 		 		this.companyName = companyName ; 
 		 		 return this ;
 		}

 		public FileDataDetailedRequestDto toFileProductName( String fileProductName){
 		 		this.fileProductName = fileProductName ; 
 		 		 return this ;
 		}

 		public FileDataDetailedRequestDto toFileBusinessName( String fileBusinessName){
 		 		this.fileBusinessName = fileBusinessName ; 
 		 		 return this ;
 		}

 		public FileDataDetailedRequestDto toUseBusinessId( long useBusinessId){
 		 		this.useBusinessId = useBusinessId ; 
 		 		 return this ;
 		}

 		public FileDataDetailedRequestDto toStorageConfigId( String storageConfigId){
 		 		this.storageConfigId = storageConfigId ; 
 		 		 return this ;
 		}

 		public FileDataDetailedRequestDto toFileSourceName( String fileSourceName){
 		 		this.fileSourceName = fileSourceName ; 
 		 		 return this ;
 		}

 		public FileDataDetailedRequestDto toFileType( String fileType){
 		 		this.fileType = fileType ; 
 		 		 return this ;
 		}

 		public FileDataDetailedRequestDto toErrorCode( String errorCode){
 		 		this.errorCode = errorCode ; 
 		 		 return this ;
 		}

 		public FileDataDetailedRequestDto toErrorMessage( String errorMessage){
