...
public class FileUploadActionWaterResponseDto  extends BaseTenantEntity implements Serializable {
        ...
        public static FileUploadActionWaterResponseDto build(){
                return new FileUploadActionWaterResponseDto();
        }

 		public FileUploadActionWaterResponseDto toCompanyId( String companyId){
 		 		this.companyId = companyId ; 
 		 		 return this ;
 		}
 		public FileUploadActionWaterResponseDto toCompanyName( String companyName){
 		 		this.companyName = companyName ; 
 		 		 return this ;
 		}
 		public FileUploadActionWaterResponseDto toDeptId( long deptId){
 		 		this.deptId = deptId ; 
 		 		 return this ;
 		}
 		public FileUploadActionWaterResponseDto toDeptName( String deptName){
 		 		this.deptName = deptName ; 
 		 		 return this ;
 		}
 		public FileUploadActionWaterResponseDto toUploadUserId( long uploadUserId){
 		 		this.uploadUserId = uploadUserId ; 
 		 		 return this ;
 		}
 		public FileUploadActionWaterResponseDto toUploadUserName( String uploadUserName){
 		 		this.uploadUserName = uploadUserName ; 
 		 		 return this ;
 		}
 		public FileUploadActionWaterResponseDto toFileProductName( String fileProductName){
 		 		this.fileProductName = fileProductName ; 
 		 		 return this ;
 		}
 		public FileUploadActionWaterResponseDto toFileBusinessName( String fileBusinessName){
 		 		this.fileBusinessName = fileBusinessName ; 
 		 		 return this ;
 		}
 		public FileUploadActionWaterResponseDto toAppId( String appId){
 		 		this.appId = appId ; 
 		 		 return this ;
 		}
 		public FileUploadActionWaterResponseDto toClientId( long clientId){
 		 		this.clientId = clientId ; 
 		 		 return this ;
 		}
 		public FileUploadActionWaterResponseDto toUseBusinessId( long useBusinessId){
 		 		this.useBusinessId = useBusinessId ; 
 		 		 return this ;
 		}
 		public FileUploadActionWaterResponseDto toStorageConfigId( String storageConfigId){
 		 		this.storageConfigId = storageConfigId ; 
 		 		 return this ;
 		}
 		public FileUploadActionWaterResponseDto toFileUploadStorageId( long fileUploadStorageId){
 		 		this.fileUploadStorageId = fileUploadStorageId ; 
 		 		 return this ;
 		}
 		public FileUploadActionWaterResponseDto toFileSourceName( String fileSourceName){
 		 		this.fileSourceName = fileSourceName ; 
 		 		 return this ;
 		}
 		public FileUploadActionWaterResponseDto toFileOssName( String fileOssName){
