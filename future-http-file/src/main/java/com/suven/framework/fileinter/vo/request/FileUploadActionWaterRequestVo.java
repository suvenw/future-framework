...
public class FileUploadActionWaterRequestVo extends HttpRequestByIdPageVo{
    ...
    public static FileUploadActionWaterRequestVo build(){
        return new FileUploadActionWaterRequestVo();
    }




 		public FileUploadActionWaterRequestVo toCompanyId( String companyId){
 		 		this.companyId = companyId ; 
 		 		 return this ;
 		}

 		public FileUploadActionWaterRequestVo toCompanyName( String companyName){
 		 		this.companyName = companyName ; 
 		 		 return this ;
 		}

 		public FileUploadActionWaterRequestVo toDeptId( long deptId){
 		 		this.deptId = deptId ; 
 		 		 return this ;
 		}

 		public FileUploadActionWaterRequestVo toDeptName( String deptName){
 		 		this.deptName = deptName ; 
 		 		 return this ;
 		}

 		public FileUploadActionWaterRequestVo toUploadUserId( long uploadUserId){
 		 		this.uploadUserId = uploadUserId ; 
 		 		 return this ;
 		}

 		public FileUploadActionWaterRequestVo toUploadUserName( String uploadUserName){
 		 		this.uploadUserName = uploadUserName ; 
 		 		 return this ;
 		}

 		public FileUploadActionWaterRequestVo toFileProductName( String fileProductName){
 		 		this.fileProductName = fileProductName ; 
 		 		 return this ;
 		}

 		public FileUploadActionWaterRequestVo toFileBusinessName( String fileBusinessName){
 		 		this.fileBusinessName = fileBusinessName ; 
 		 		 return this ;
 		}

 		public FileUploadActionWaterRequestVo toAppId( String appId){
 		 		this.appId = appId ; 
 		 		 return this ;
 		}

 		public FileUploadActionWaterRequestVo toClientId( long clientId){
 		 		this.clientId = clientId ; 
 		 		 return this ;
 		}

 		public FileUploadActionWaterRequestVo toUseBusinessId( long useBusinessId){
 		 		this.useBusinessId = useBusinessId ; 
 		 		 return this ;
 		}

 		public FileUploadActionWaterRequestVo toStorageConfigId( String storageConfigId){
 		 		this.storageConfigId = storageConfigId ; 
 		 		 return this ;
 		}

 		public FileUploadActionWaterRequestVo toFileUploadStorageId( long fileUploadStorageId){
 		 		this.fileUploadStorageId = fileUploadStorageId ; 
 		 		 return this ;
 		}

 		public FileUploadActionWaterRequestVo toFileSourceName( String fileSourceName){
 		 		this.fileSourceName = fileSourceName ; 
 		 		 return this ;
 		}

 		public FileUploadActionWaterRequestVo toFileOssName( String fileOssName){
