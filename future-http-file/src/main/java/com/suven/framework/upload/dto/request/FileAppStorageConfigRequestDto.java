...
public class FileAppStorageConfigRequestDto extends BaseTenantEntity implements Serializable{
        ...
        public static FileAppStorageConfigRequestDto build(){
            return new FileAppStorageConfigRequestDto();
        }


 		public FileAppStorageConfigRequestDto toAppId( String appId){
 		 		this.appId = appId ; 
 		 		 return this ;
 		}

 		public FileAppStorageConfigRequestDto toAppName( String appName){
 		 		this.appName = appName ; 
 		 		 return this ;
 		}

 		public FileAppStorageConfigRequestDto toClientId( String clientId){
 		 		this.clientId = clientId ; 
 		 		 return this ;
 		}

 		public FileAppStorageConfigRequestDto toStorageConfigId( String storageConfigId){
 		 		this.storageConfigId = storageConfigId ; 
 		 		 return this ;
 		}

 		public FileAppStorageConfigRequestDto toConfigFiledName( String configFiledName){
 		 		this.configFiledName = configFiledName ; 
 		 		 return this ;
 		}

 		public FileAppStorageConfigRequestDto toConfigFiledValue( String configFiledValue){
