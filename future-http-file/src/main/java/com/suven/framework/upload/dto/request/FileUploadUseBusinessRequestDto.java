...
@Setter
@Getter
public class FileUploadUseBusinessRequestDto extends BaseTenantEntity implements Serializable{
        ...
        public static FileUploadUseBusinessRequestDto build(){
            return new FileUploadUseBusinessRequestDto();
        }


 		public FileUploadUseBusinessRequestDto toAppId( String appId){
 		 		this.appId = appId ; 
 		 		 return this ;
 		}

 		public FileUploadUseBusinessRequestDto toClientId( String clientId){
 		 		this.clientId = clientId ; 
 		 		 return this ;
 		}

 		public FileUploadUseBusinessRequestDto toCompanyId( String companyId){
 		 		this.companyId = companyId ; 
 		 		 return this ;
 		}

 		public FileUploadUseBusinessRequestDto toCompanyName( String companyName){
 		 		this.companyName = companyName ; 
 		 		 return this ;
 		}

 		public FileUploadUseBusinessRequestDto toFileProductName( String fileProductName){
 		 		this.fileProductName = fileProductName ; 
 		 		 return this ;
 		}

 		public FileUploadUseBusinessRequestDto toFileBusinessName( String fileBusinessName){
 		 		this.fileBusinessName = fileBusinessName ; 
 		 		 return this ;
 		}

 		public FileUploadUseBusinessRequestDto toCallbackService( String callbackService){
 		 		this.callbackService = callbackService ; 
 		 		 return this ;
 		}

 		public FileUploadUseBusinessRequestDto toCallbackAsyncService( String callbackAsyncService){
 		 		this.callbackAsyncService = callbackAsyncService ; 
 		 		 return this ;
 		}

 		public FileUploadUseBusinessRequestDto toDataForm( String dataForm){
 		 		this.dataForm = dataForm ; 
 		 		 return this ;
 		}

 		public FileUploadUseBusinessRequestDto toFormType( String formType){
 		 		this.formType = formType ; 
 		 		 return this ;
 		}

 		public FileUploadUseBusinessRequestDto toInterpretData( int interpretData){
 		 		this.interpretData = interpretData ; 
 		 		 return this ;
 		}

 		public FileUploadUseBusinessRequestDto toCheckData( int checkData){
 		 		this.checkData = checkData ; 
 		 		 return this ;
 		}

 		public FileUploadUseBusinessRequestDto toAccessExpirationTime( String accessExpirationTime){
 		 		this.accessExpirationTime = accessExpirationTime ; 
 		 		 return this ;
 		}

 		public FileUploadUseBusinessRequestDto toAccessCount( int accessCount){
 		 		this.accessCount = accessCount ; 
 		 		 return this ;
 		}

 		public FileUploadUseBusinessRequestDto toAccessUrlFormat( String accessUrlFormat){
