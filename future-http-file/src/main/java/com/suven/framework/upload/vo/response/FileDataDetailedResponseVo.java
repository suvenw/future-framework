...
public class FileDataDetailedResponseVo  extends BaseTenantEntity implements Serializable {
    ...
    public static FileDataDetailedResponseVo build(){
        return new FileDataDetailedResponseVo();
    }


 		public FileDataDetailedResponseVo toAppId( String appId){
 		 		this.appId = appId ; 
 		 		 return this ;
 		}

 		public FileDataDetailedResponseVo toAppName( String appName){
 		 		this.appName = appName ; 
 		 		 return this ;
 		}

 		public FileDataDetailedResponseVo toClientId( long clientId){
 		 		this.clientId = clientId ; 
 		 		 return this ;
 		}

 		public FileDataDetailedResponseVo toCompanyId( String companyId){
 		 		this.companyId = companyId ; 
 		 		 return this ;
 		}

 		public FileDataDetailedResponseVo toCompanyName( String companyName){
 		 		this.companyName = companyName ; 
 		 		 return this ;
 		}

 		public FileDataDetailedResponseVo toFileProductName( String fileProductName){
 		 		this.fileProductName = fileProductName ; 
 		 		 return this ;
 		}

 		public FileDataDetailedResponseVo toFileBusinessName( String fileBusinessName){
 		 		this.fileBusinessName = fileBusinessName ; 
 		 		 return this ;
 		}

 		public FileDataDetailedResponseVo toUseBusinessId( long useBusinessId){
 		 		this.useBusinessId = useBusinessId ; 
 		 		 return this ;
 		}

 		public FileDataDetailedResponseVo toStorageConfigId( String storageConfigId){
 		 		this.storageConfigId = storageConfigId ; 
 		 		 return this ;
 		}

 		public FileDataDetailedResponseVo toFileSourceName( String fileSourceName){
 		 		this.fileSourceName = fileSourceName ; 
 		 		 return this ;
 		}

 		public FileDataDetailedResponseVo toFileType( String fileType){
 		 		this.fileType = fileType ; 
 		 		 return this ;
 		}

 		public FileDataDetailedResponseVo toErrorCode( String errorCode){
 		 		this.errorCode = errorCode ; 
 		 		 return this ;
 		}

 		public FileDataDetailedResponseVo toErrorMessage( String errorMessage){
