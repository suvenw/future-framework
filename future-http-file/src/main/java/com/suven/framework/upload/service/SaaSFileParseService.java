 ...
 */
public interface SaaSFileParseService {
     ...
     */
    SaaSFileParseResultDto parse(InputStream inputStream, String fileName, String fileType);
     ...
     * @return SaaSFileParseResultDto 解析结果
     */
    SaaSFileParseResultDto parseWithMapping(
