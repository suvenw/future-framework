...
public class FileAppStorageConfigResponseDto  extends BaseTenantEntity implements Serializable {
        ...
        public static FileAppStorageConfigResponseDto build(){
                return new FileAppStorageConfigResponseDto();
        }

 		public FileAppStorageConfigResponseDto toAppId( String appId){
 		 		this.appId = appId ; 
 		 		 return this ;
 		}
 		public FileAppStorageConfigResponseDto toAppName( String appName){
 		 		this.appName = appName ; 
 		 		 return this ;
 		}
 		public FileAppStorageConfigResponseDto toClientId( String clientId){
 		 		this.clientId = clientId ; 
 		 		 return this ;
 		}
 		public FileAppStorageConfigResponseDto toStorageConfigId( String storageConfigId){
 		 		this.storageConfigId = storageConfigId ; 
 		 		 return this ;
 		}
 		public FileAppStorageConfigResponseDto toConfigFiledName( String configFiledName){
 		 		this.configFiledName = configFiledName ; 
 		 		 return this ;
 		}
 		public FileAppStorageConfigResponseDto toConfigFiledValue( String configFiledValue){
