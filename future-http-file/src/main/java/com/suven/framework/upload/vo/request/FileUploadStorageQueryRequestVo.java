...
public class FileUploadStorageQueryRequestVo extends HttpRequestByIdPageVo{
    ...
    public static FileUploadStorageQueryRequestVo build(){
        return new FileUploadStorageQueryRequestVo();
    }




 		public FileUploadStorageQueryRequestVo toIdempotent( long idempotent){
 		 		this.idempotent = idempotent ; 
 		 		 return this ;
 		}


 		public FileUploadStorageQueryRequestVo toAppId( String appId){
 		 		this.appId = appId ; 
 		 		 return this ;
 		}


 		public FileUploadStorageQueryRequestVo toClientId( long clientId){
 		 		this.clientId = clientId ; 
 		 		 return this ;
 		}


 		public FileUploadStorageQueryRequestVo toUseBusinessId( long useBusinessId){
 		 		this.useBusinessId = useBusinessId ; 
 		 		 return this ;
 		}


 		public FileUploadStorageQueryRequestVo toStorageConfigId( String storageConfigId){
 		 		this.storageConfigId = storageConfigId ; 
 		 		 return this ;
 		}


 		public FileUploadStorageQueryRequestVo toFileSourceName( String fileSourceName){
 		 		this.fileSourceName = fileSourceName ; 
 		 		 return this ;
 		}


 		public FileUploadStorageQueryRequestVo toFileMd5( String fileMd5){
 		 		this.fileMd5 = fileMd5 ; 
 		 		 return this ;
 		}


 		public FileUploadStorageQueryRequestVo toFileType( String fileType){
 		 		this.fileType = fileType ; 
 		 		 return this ;
 		}


 		public FileUploadStorageQueryRequestVo toFileSize( long fileSize){
 		 		this.fileSize = fileSize ; 
 		 		 return this ;
 		}


 		public FileUploadStorageQueryRequestVo toBucketName( String bucketName){
 		 		this.bucketName = bucketName ; 
 		 		 return this ;
 		}


 		public FileUploadStorageQueryRequestVo toOssKey( String ossKey){
 		 		this.ossKey = ossKey ; 
 		 		 return this ;
 		}


 		public FileUploadStorageQueryRequestVo toFileOssName( String fileOssName){
 		 		this.fileOssName = fileOssName ; 
 		 		 return this ;
 		}


 		public FileUploadStorageQueryRequestVo toFileOssStorePath( String fileOssStorePath){
 		 		this.fileOssStorePath = fileOssStorePath ; 
 		 		 return this ;
 		}


 		public FileUploadStorageQueryRequestVo toFileDomain( String fileDomain){
 		 		this.fileDomain = fileDomain ; 
 		 		 return this ;
 		}


 		public FileUploadStorageQueryRequestVo toFileAccessUrl( String fileAccessUrl){
 		 		this.fileAccessUrl = fileAccessUrl ; 
 		 		 return this ;
 		}


 		public FileUploadStorageQueryRequestVo toAccessExpirationTime( String accessExpirationTime){
 		 		this.accessExpirationTime = accessExpirationTime ; 
 		 		 return this ;
 		}


 		public FileUploadStorageQueryRequestVo toAccessCount( int accessCount){
 		 		this.accessCount = accessCount ; 
 		 		 return this ;
 		}


 		public FileUploadStorageQueryRequestVo toAccessUrlFormat( String accessUrlFormat){
 		 		this.accessUrlFormat = accessUrlFormat ; 
 		 		 return this ;
 		}


 		public FileUploadStorageQueryRequestVo toCallbackValidate( String callbackValidate){
 		 		this.callbackValidate = callbackValidate ; 
 		 		 return this ;
 		}


 		public FileUploadStorageQueryRequestVo toInterpretData( int interpretData){
 		 		this.interpretData = interpretData ; 
 		 		 return this ;
 		}


 		public FileUploadStorageQueryRequestVo toInterpretDataTotal( int interpretDataTotal){
 		 		this.interpretDataTotal = interpretDataTotal ; 
 		 		 return this ;
 		}


 		public FileUploadStorageQueryRequestVo toFileHistory( int fileHistory){
 		 		this.fileHistory = fileHistory ; 
 		 		 return this ;
 		}


 		public FileUploadStorageQueryRequestVo toFileHistoryStorePath( String fileHistoryStorePath){
 		 		this.fileHistoryStorePath = fileHistoryStorePath ; 
 		 		 return this ;
 		}


 		public FileUploadStorageQueryRequestVo toRemark( String remark){
 		 		this.remark = remark ; 
 		 		 return this ;
 		}


 		public FileUploadStorageQueryRequestVo toCreateDate( Date createDate){
 		 		this.createDate = createDate ; 
 		 		 return this ;
 		}


 		public FileUploadStorageQueryRequestVo toModifyDate( Date modifyDate){
 		 		this.modifyDate = modifyDate ; 
 		 		 return this ;
 		}


 		public FileUploadStorageQueryRequestVo toTenantId( long tenantId){
 		 		this.tenantId = tenantId ; 
 		 		 return this ;
 		}


 		public FileUploadStorageQueryRequestVo toDeleted( int deleted){
