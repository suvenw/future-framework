...
public class FileUploadUseBusinessQueryRequestVo extends HttpRequestByIdPageVo{
    ...
    public static FileUploadUseBusinessQueryRequestVo build(){
        return new FileUploadUseBusinessQueryRequestVo();
    }




 		public FileUploadUseBusinessQueryRequestVo toAppId( String appId){
 		 		this.appId = appId ; 
 		 		 return this ;
 		}


 		public FileUploadUseBusinessQueryRequestVo toClientId( String clientId){
 		 		this.clientId = clientId ; 
 		 		 return this ;
 		}


 		public FileUploadUseBusinessQueryRequestVo toCompanyId( String companyId){
 		 		this.companyId = companyId ; 
 		 		 return this ;
 		}


 		public FileUploadUseBusinessQueryRequestVo toCompanyName( String companyName){
 		 		this.companyName = companyName ; 
 		 		 return this ;
 		}


 		public FileUploadUseBusinessQueryRequestVo toFileProductName( String fileProductName){
 		 		this.fileProductName = fileProductName ; 
 		 		 return this ;
 		}


 		public FileUploadUseBusinessQueryRequestVo toFileBusinessName( String fileBusinessName){
 		 		this.fileBusinessName = fileBusinessName ; 
 		 		 return this ;
 		}


 		public FileUploadUseBusinessQueryRequestVo toCallbackService( String callbackService){
 		 		this.callbackService = callbackService ; 
 		 		 return this ;
 		}


 		public FileUploadUseBusinessQueryRequestVo toCallbackAsyncService( String callbackAsyncService){
 		 		this.callbackAsyncService = callbackAsyncService ; 
 		 		 return this ;
 		}


 		public FileUploadUseBusinessQueryRequestVo toDataForm( String dataForm){
 		 		this.dataForm = dataForm ; 
 		 		 return this ;
 		}


 		public FileUploadUseBusinessQueryRequestVo toFormType( String formType){
 		 		this.formType = formType ; 
 		 		 return this ;
 		}


 		public FileUploadUseBusinessQueryRequestVo toInterpretData( int interpretData){
 		 		this.interpretData = interpretData ; 
 		 		 return this ;
 		}


 		public FileUploadUseBusinessQueryRequestVo toCheckData( int checkData){
 		 		this.checkData = checkData ; 
 		 		 return this ;
 		}


 		public FileUploadUseBusinessQueryRequestVo toAccessExpirationTime( String accessExpirationTime){
 		 		this.accessExpirationTime = accessExpirationTime ; 
 		 		 return this ;
 		}


 		public FileUploadUseBusinessQueryRequestVo toAccessCount( int accessCount){
 		 		this.accessCount = accessCount ; 
 		 		 return this ;
 		}


 		public FileUploadUseBusinessQueryRequestVo toAccessUrlFormat( String accessUrlFormat){
 		 		this.accessUrlFormat = accessUrlFormat ; 
 		 		 return this ;
 		}


 		public FileUploadUseBusinessQueryRequestVo toCreateDate( Date createDate){
 		 		this.createDate = createDate ; 
 		 		 return this ;
 		}


 		public FileUploadUseBusinessQueryRequestVo toModifyDate( Date modifyDate){
 		 		this.modifyDate = modifyDate ; 
 		 		 return this ;
 		}


 		public FileUploadUseBusinessQueryRequestVo toTenantId( long tenantId){
 		 		this.tenantId = tenantId ; 
 		 		 return this ;
 		}


 		public FileUploadUseBusinessQueryRequestVo toDeleted( int deleted){
