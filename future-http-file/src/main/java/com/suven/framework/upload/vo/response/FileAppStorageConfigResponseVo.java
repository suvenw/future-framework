...
public class FileAppStorageConfigResponseVo  extends BaseTenantEntity implements Serializable {
    ...
    public static FileAppStorageConfigResponseVo build(){
        return new FileAppStorageConfigResponseVo();
    }


 		public FileAppStorageConfigResponseVo toAppId( String appId){
 		 		this.appId = appId ; 
 		 		 return this ;
 		}

 		public FileAppStorageConfigResponseVo toAppName( String appName){
 		 		this.appName = appName ; 
 		 		 return this ;
 		}

 		public FileAppStorageConfigResponseVo toClientId( String clientId){
 		 		this.clientId = clientId ; 
 		 		 return this ;
 		}

 		public FileAppStorageConfigResponseVo toStorageConfigId( String storageConfigId){
 		 		this.storageConfigId = storageConfigId ; 
 		 		 return this ;
 		}

 		public FileAppStorageConfigResponseVo toConfigFiledName( String configFiledName){
 		 		this.configFiledName = configFiledName ; 
 		 		 return this ;
 		}

 		public FileAppStorageConfigResponseVo toConfigFiledValue( String configFiledValue){
