...
@NoArgsConstructor
@AllArgsConstructor
public class SaaSFileParseResultDto {
     ...
     * @param fileType 文件类型
     * @param fileName 文件名称
     * @return SaaSFileParseResultDto
     */
    public static SaaSFileParseResultDto success(String fileType, String fileName) {
     ...
     * @return SaaSFileParseResultDto
     */
    public static SaaSFileParseResultDto fail(String fileType, String fileName, String errorMessage) {
        return SaaSFileParseResultDto.builder()
                .success(false)
                .fileType(fileType)
                .fileName(fileName)
