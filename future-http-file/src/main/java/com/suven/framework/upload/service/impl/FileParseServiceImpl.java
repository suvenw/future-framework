...
public class FileParseServiceImpl implements FileParseService {
    ...
    @Autowired
    private FileParseService xlsFileParser;

    @Autowired
    private FileParseService csvFileParser;
     ...
     */
    public FileInterpretRecord parseAndSaveInterpretRecord(
            long fileUploadId,
            InputStream inputStream, 
            String fileName, 
            String fileType,
        ...
        try {
            // 获取字段映射
            List<FileFieldMapping> fieldMappings = getFieldMappingsByUploadId(fileUploadId);
     ...
     * @return 字段映射列表
     */
    private List<FileFieldMapping> getFieldMappingsByUploadId(long fileUploadId) {
        try {
