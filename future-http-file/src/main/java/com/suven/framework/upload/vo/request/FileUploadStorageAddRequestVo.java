...
public class FileUploadStorageAddRequestVo extends HttpRequestByIdVo{
    ...
    public static FileUploadStorageAddRequestVo build(){
        return new FileUploadStorageAddRequestVo();
    }




 		public FileUploadStorageAddRequestVo toIdempotent( long idempotent){
 		 		this.idempotent = idempotent ; 
 		 		 return this ;
 		}
 
 		public FileUploadStorageAddRequestVo toAppId( String appId){
 		 		this.appId = appId ; 
 		 		 return this ;
 		}
 
 		public FileUploadStorageAddRequestVo toClientId( long clientId){
 		 		this.clientId = clientId ; 
 		 		 return this ;
 		}
 
 		public FileUploadStorageAddRequestVo toUseBusinessId( long useBusinessId){
 		 		this.useBusinessId = useBusinessId ; 
 		 		 return this ;
 		}
 
 		public FileUploadStorageAddRequestVo toStorageConfigId( String storageConfigId){
 		 		this.storageConfigId = storageConfigId ; 
 		 		 return this ;
 		}
 
 		public FileUploadStorageAddRequestVo toFileSourceName( String fileSourceName){
 		 		this.fileSourceName = fileSourceName ; 
 		 		 return this ;
 		}
 
 		public FileUploadStorageAddRequestVo toFileMd5( String fileMd5){
 		 		this.fileMd5 = fileMd5 ; 
 		 		 return this ;
 		}
 
 		public FileUploadStorageAddRequestVo toFileType( String fileType){
 		 		this.fileType = fileType ; 
 		 		 return this ;
 		}
 
 		public FileUploadStorageAddRequestVo toFileSize( long fileSize){
 		 		this.fileSize = fileSize ; 
 		 		 return this ;
 		}
 
 		public FileUploadStorageAddRequestVo toBucketName( String bucketName){
 		 		this.bucketName = bucketName ; 
 		 		 return this ;
 		}
 
 		public FileUploadStorageAddRequestVo toOssKey( String ossKey){
 		 		this.ossKey = ossKey ; 
 		 		 return this ;
 		}
 
 		public FileUploadStorageAddRequestVo toFileOssName( String fileOssName){
 		 		this.fileOssName = fileOssName ; 
 		 		 return this ;
 		}
 
 		public FileUploadStorageAddRequestVo toFileOssStorePath( String fileOssStorePath){
 		 		this.fileOssStorePath = fileOssStorePath ; 
 		 		 return this ;
 		}
 
 		public FileUploadStorageAddRequestVo toFileDomain( String fileDomain){
 		 		this.fileDomain = fileDomain ; 
 		 		 return this ;
 		}
 
 		public FileUploadStorageAddRequestVo toFileAccessUrl( String fileAccessUrl){
 		 		this.fileAccessUrl = fileAccessUrl ; 
 		 		 return this ;
 		}
 
 		public FileUploadStorageAddRequestVo toAccessExpirationTime( String accessExpirationTime){
 		 		this.accessExpirationTime = accessExpirationTime ; 
 		 		 return this ;
 		}
 
 		public FileUploadStorageAddRequestVo toAccessCount( int accessCount){
 		 		this.accessCount = accessCount ; 
 		 		 return this ;
 		}
 
 		public FileUploadStorageAddRequestVo toAccessUrlFormat( String accessUrlFormat){
 		 		this.accessUrlFormat = accessUrlFormat ; 
 		 		 return this ;
 		}
 
 		public FileUploadStorageAddRequestVo toCallbackValidate( String callbackValidate){
 		 		this.callbackValidate = callbackValidate ; 
 		 		 return this ;
 		}
 
 		public FileUploadStorageAddRequestVo toInterpretData( int interpretData){
 		 		this.interpretData = interpretData ; 
 		 		 return this ;
 		}
 
 		public FileUploadStorageAddRequestVo toInterpretDataTotal( int interpretDataTotal){
 		 		this.interpretDataTotal = interpretDataTotal ; 
 		 		 return this ;
 		}
 
 		public FileUploadStorageAddRequestVo toFileHistory( int fileHistory){
 		 		this.fileHistory = fileHistory ; 
 		 		 return this ;
 		}
 
 		public FileUploadStorageAddRequestVo toFileHistoryStorePath( String fileHistoryStorePath){
 		 		this.fileHistoryStorePath = fileHistoryStorePath ; 
 		 		 return this ;
 		}
 
 		public FileUploadStorageAddRequestVo toRemark( String remark){
 		 		this.remark = remark ; 
 		 		 return this ;
 		}
 
 		public FileUploadStorageAddRequestVo toCreateDate( Date createDate){
 		 		this.createDate = createDate ; 
 		 		 return this ;
 		}
 
 		public FileUploadStorageAddRequestVo toModifyDate( Date modifyDate){
 		 		this.modifyDate = modifyDate ; 
 		 		 return this ;
 		}
 
 		public FileUploadStorageAddRequestVo toTenantId( long tenantId){
 		 		this.tenantId = tenantId ; 
 		 		 return this ;
 		}
 
 		public FileUploadStorageAddRequestVo toDeleted( int deleted){
