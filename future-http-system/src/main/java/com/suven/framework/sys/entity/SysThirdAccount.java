...
/**
  * ClassName: SysThirdAccount.java
  *
  * @author 作者 : suven
...
public class SysThirdAccount extends BaseByTimeEntity{
...
private static final long serialVersionUID = 1L;
    ...
    public static SysThirdAccount build(){
        return new SysThirdAccount();
    }

 		public void setSysUserId( String sysUserId){
 		 		this.sysUserId = sysUserId ; 
 		 		}
 		public SysThirdAccount toSysUserId( String sysUserId){
 		 		this.sysUserId = sysUserId ; 
 		 		 return this ;
 		}
 		...
 		public SysThirdAccount toAvatar( String avatar){
 		 		this.avatar = avatar ; 
 		 		 return this ;
 		}
 		...
 		public SysThirdAccount toStatus( int status){
 		 		this.status = status ; 
 		 		 return this ;
 		}
 		...
 		public SysThirdAccount toDelFlag( int delFlag){
 		 		this.delFlag = delFlag ; 
 		 		 return this ;
 		}
 		...
 		public SysThirdAccount toRealname( String realname){
 		 		this.realname = realname ; 
 		 		 return this ;
 		}
 		...
 		public SysThirdAccount toThirdUserUuid( String thirdUserUuid){
 		 		this.thirdUserUuid = thirdUserUuid ; 
 		 		 return this ;
 		}
 		...
 		public SysThirdAccount toThirdUserId( String thirdUserId){
 		 		this.thirdUserId = thirdUserId ; 
 		 		 return this ;
 		}
 		...
 		public SysThirdAccount toThirdType( String thirdType){
 		 		this.thirdType = thirdType ; 
 		 		 return this ;
 		}
