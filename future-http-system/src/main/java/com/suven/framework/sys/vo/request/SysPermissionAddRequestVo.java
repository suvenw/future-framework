...
/**
 * @ClassName: SysPermissionAddRequestVo.java
 *
 * @Author 作者 : suven
...
public class SysPermissionAddRequestVo extends HttpRequestByIdVo{
    ...
    public static SysPermissionAddRequestVo build(){
        return new SysPermissionAddRequestVo();
    }
 		...
 		public SysPermissionAddRequestVo toParentId( long parentId){
 		 		this.parentId = parentId ; 
 		 		 return this ;
 		}
 		...
 		public SysPermissionAddRequestVo toName( String name){
 		 		this.name = name ; 
 		 		 return this ;
 		}
 		...
 		public SysPermissionAddRequestVo toUrl( String url){
 		 		this.url = url ; 
 		 		 return this ;
 		}
 		...
 		public SysPermissionAddRequestVo toComponent( String component){
 		 		this.component = component ; 
 		 		 return this ;
 		}
 		...
 		public SysPermissionAddRequestVo toComponentName( String componentName){
 		 		this.componentName = componentName ; 
 		 		 return this ;
 		}
 		...
 		public SysPermissionAddRequestVo toRedirect( String redirect){
 		 		this.redirect = redirect ; 
 		 		 return this ;
 		}
 		...
 		public SysPermissionAddRequestVo toMenuType( int menuType){
 		 		this.menuType = menuType ; 
 		 		 return this ;
 		}
 		...
 		public SysPermissionAddRequestVo toPerms( String perms){
 		 		this.perms = perms ; 
 		 		 return this ;
 		}
 		...
 		public SysPermissionAddRequestVo toPermsType( String permsType){
 		 		this.permsType = permsType ; 
 		 		 return this ;
 		}
 		...
 		public SysPermissionAddRequestVo toSortNo( double sortNo){
 		 		this.sortNo = sortNo ; 
 		 		 return this ;
 		}
 		...
 		public SysPermissionAddRequestVo toAlwaysShow( int alwaysShow){
 		 		this.alwaysShow = alwaysShow ; 
 		 		 return this ;
 		}
 		...
 		public SysPermissionAddRequestVo toIcon( String icon){
 		 		this.icon = icon ; 
 		 		 return this ;
 		}
 		...
 		public SysPermissionAddRequestVo toIsRoute( int isRoute){
 		 		this.isRoute = isRoute ; 
 		 		 return this ;
 		}
 		...
 		public SysPermissionAddRequestVo toIsLeaf( int isLeaf){
 		 		this.isLeaf = isLeaf ; 
 		 		 return this ;
 		}
 		...
 		public SysPermissionAddRequestVo toKeepAlive( int keepAlive){
 		 		this.keepAlive = keepAlive ; 
 		 		 return this ;
 		}
 		...
 		public SysPermissionAddRequestVo toHidden( int hidden){
 		 		this.hidden = hidden ; 
 		 		 return this ;
 		}
 		...
 		public SysPermissionAddRequestVo toHideTab( int hideTab){
 		 		this.hideTab = hideTab ; 
 		 		 return this ;
 		}
 		...
 		public SysPermissionAddRequestVo toDescription( String description){
 		 		this.description = description ; 
 		 		 return this ;
 		}
 		...
 		public SysPermissionAddRequestVo toCreateBy( String createBy){
 		 		this.createBy = createBy ; 
 		 		 return this ;
 		}
 		...
 		public SysPermissionAddRequestVo toCreateTime( Date createTime){
 		 		this.createTime = createTime ; 
 		 		 return this ;
 		}
 		...
 		public SysPermissionAddRequestVo toUpdateBy( String updateBy){
 		 		this.updateBy = updateBy ; 
 		 		 return this ;
 		}
 		...
 		public SysPermissionAddRequestVo toUpdateTime( Date updateTime){
 		 		this.updateTime = updateTime ; 
 		 		 return this ;
 		}
 		...
 		public SysPermissionAddRequestVo toDelFlag( int delFlag){
 		 		this.delFlag = delFlag ; 
 		 		 return this ;
 		}
 		...
 		public SysPermissionAddRequestVo toRuleFlag( int ruleFlag){
 		 		this.ruleFlag = ruleFlag ; 
 		 		 return this ;
 		}
 		...
 		public SysPermissionAddRequestVo toStatus( int status){
 		 		this.status = status ; 
 		 		 return this ;
 		}
 		...
 		public SysPermissionAddRequestVo toInternalOrExternal( int internalOrExternal){
 		 		this.internalOrExternal = internalOrExternal ; 
 		 		 return this ;
 		}
