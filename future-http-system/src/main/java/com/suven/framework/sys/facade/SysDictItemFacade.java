...
import com.suven.framework.sys.vo.request.SysDictItemRequestVo;
...
/**
  * @ClassName: SysDictItemFacade.java
  *
  * @Author 作者 : suven
  ...
  * <pre>
  *
  *  Description: 数据字典明细表 的业务综合处理门面实现逻辑类
  *
  * </pre>
  * <pre>
  * 修改记录
...
@Component
public class SysDictItemFacade {
