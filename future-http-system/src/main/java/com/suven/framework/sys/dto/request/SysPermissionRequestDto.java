...
import com.suven.framework.http.data.entity.BaseByTimeEntity;
import com.suven.framework.http.api.ApiDesc;

/**
 * @ClassName: SysPermissionRequestDto.java
 *
 * @Author 作者 : suven
 ...
 * <pre>
 *
 *  Description: 菜单权限表 RPC业务接口交互数据请求参数实现类
 *
 * </pre>
 * <pre>
 * 修改记录
...
public class SysPermissionRequestDto extends BaseByTimeEntity implements Serializable{


        private Logger logger = LoggerFactory.getLogger(SysPermissionRequestDto.class);
        ...
        public static SysPermissionRequestDto build(){
            return new SysPermissionRequestDto();
        }

 		public void setParentId( long parentId){
 		 		this.parentId = parentId ; 
 		 		}
 		public SysPermissionRequestDto toParentId( long parentId){
 		 		this.parentId = parentId ; 
 		 		 return this ;
 		}
 		...
 		public SysPermissionRequestDto toName( String name){
 		 		this.name = name ; 
 		 		 return this ;
 		}
 		...
 		public SysPermissionRequestDto toUrl( String url){
 		 		this.url = url ; 
 		 		 return this ;
 		}
 		...
 		public SysPermissionRequestDto toComponent( String component){
 		 		this.component = component ; 
 		 		 return this ;
 		}
 		...
 		public SysPermissionRequestDto toComponentName( String componentName){
 		 		this.componentName = componentName ; 
 		 		 return this ;
 		}
 		...
 		public SysPermissionRequestDto toRedirect( String redirect){
 		 		this.redirect = redirect ; 
 		 		 return this ;
 		}
 		...
 		public SysPermissionRequestDto toMenuType( int menuType){
 		 		this.menuType = menuType ; 
 		 		 return this ;
 		}
 		...
 		public SysPermissionRequestDto toPerms( String perms){
 		 		this.perms = perms ; 
 		 		 return this ;
 		}
 		...
 		public SysPermissionRequestDto toPermsType( String permsType){
 		 		this.permsType = permsType ; 
 		 		 return this ;
 		}
 		...
 		public SysPermissionRequestDto toSortNo( double sortNo){
 		 		this.sortNo = sortNo ; 
 		 		 return this ;
 		}
 		...
 		public SysPermissionRequestDto toAlwaysShow( int alwaysShow){
 		 		this.alwaysShow = alwaysShow ; 
 		 		 return this ;
 		}
 		...
 		public SysPermissionRequestDto toIcon( String icon){
 		 		this.icon = icon ; 
 		 		 return this ;
 		}
 		...
 		public SysPermissionRequestDto toIsRoute( int isRoute){
 		 		this.isRoute = isRoute ; 
 		 		 return this ;
 		}
 		...
 		public SysPermissionRequestDto toIsLeaf( int isLeaf){
 		 		this.isLeaf = isLeaf ; 
 		 		 return this ;
 		}
 		...
 		public SysPermissionRequestDto toKeepAlive( int keepAlive){
 		 		this.keepAlive = keepAlive ; 
 		 		 return this ;
 		}
 		...
 		public SysPermissionRequestDto toHidden( int hidden){
 		 		this.hidden = hidden ; 
 		 		 return this ;
 		}
 		...
 		public SysPermissionRequestDto toHideTab( int hideTab){
 		 		this.hideTab = hideTab ; 
 		 		 return this ;
 		}
 		...
 		public SysPermissionRequestDto toDescription( String description){
 		 		this.description = description ; 
 		 		 return this ;
 		}
 		...
 		public SysPermissionRequestDto toDelFlag( int delFlag){
 		 		this.delFlag = delFlag ; 
 		 		 return this ;
 		}
 		...
 		public SysPermissionRequestDto toRuleFlag( int ruleFlag){
 		 		this.ruleFlag = ruleFlag ; 
 		 		 return this ;
 		}
 		...
 		public SysPermissionRequestDto toStatus( int status){
 		 		this.status = status ; 
 		 		 return this ;
 		}
 		...
 		public SysPermissionRequestDto toInternalOrExternal( int internalOrExternal){
 		 		this.internalOrExternal = internalOrExternal ; 
 		 		 return this ;
 		}
