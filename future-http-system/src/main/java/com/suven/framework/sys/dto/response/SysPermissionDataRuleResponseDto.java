 ...
 * <pre>
 *
 *  Description: 菜单权限规则表 RPC业务接口交互数据返回实现类
 *
 * </pre>
 * <pre>
 * 修改记录
...
public class SysPermissionDataRuleResponseDto  extends BaseByTimeEntity implements Serializable {
        ...
        public static SysPermissionDataRuleResponseDto build(){
 		...
 		public SysPermissionDataRuleResponseDto toStatus( int status){
 		 		this.status = status ; 
 		 		 return this ;
 		}
