...
public class SysPermissionResponseVo  extends BaseByTimeEntity implements Serializable {
 		...
 		@ExcelProperty(value = "聚合子路由: 1是0否")
 		...
 		@ExcelProperty(value = "是否路由菜单: 0:不是  1:是（默认值1）")
 		private int isRoute;

 		/** is_leaf 是否叶子节点:    1:是   0:不是  */
 		@ApiDesc(value = "是否叶子节点:    1:是   0:不是", required = 0)
 		@ExcelProperty(value = "是否叶子节点:    1:是   0:不是")
 		private int isLeaf;
 		...
 		@ExcelProperty(value = "是否隐藏路由: 0否,1是")
 		private int hidden;

 		/** hide_tab 是否隐藏tab: 0否,1是  */
 		@ApiDesc(value = "是否隐藏tab: 0否,1是", required = 0)
 		@ExcelProperty(value = "是否隐藏tab: 0否,1是")
 		private int hideTab;
    ...
    public static SysPermissionResponseVo build(){
        return new SysPermissionResponseVo();
 		...
 		public SysPermissionResponseVo toPermsType( String permsType){
 		 		this.permsType = permsType ; 
 		 		 return this ;
 		}
 		...
 		public SysPermissionResponseVo toSortNo( double sortNo){
 		 		this.sortNo = sortNo ; 
 		 		 return this ;
 		}
 		...
 		public SysPermissionResponseVo toHideTab( int hideTab){
 		 		this.hideTab = hideTab ; 
 		 		 return this ;
 		}
 		...
 		public SysPermissionResponseVo toStatus( int status){
 		 		this.status = status ; 
 		 		 return this ;
 		}
 		...
 		public SysPermissionResponseVo toInternalOrExternal( int internalOrExternal){
 		 		this.internalOrExternal = internalOrExternal ; 
 		 		 return this ;
 		}
