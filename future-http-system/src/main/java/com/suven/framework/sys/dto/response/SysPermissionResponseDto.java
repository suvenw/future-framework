...
public class SysPermissionResponseDto  extends BaseByTimeEntity implements Serializable {
	...
	public static SysPermissionResponseDto buildIndex(){
		return new SysPermissionResponseDto()
 		...
 		public SysPermissionResponseDto toParentId( long parentId){
 		 		this.parentId = parentId ; 
 		 		 return this ;
 		}
 		...
 		public SysPermissionResponseDto toName( String name){
 		 		this.name = name ; 
 		 		 return this ;
 		}
 		...
 		public SysPermissionResponseDto toUrl( String url){
 		 		this.url = url ; 
 		 		 return this ;
 		}
 		...
 		public SysPermissionResponseDto toComponent( String component){
 		 		this.component = component ; 
 		 		 return this ;
 		}
 		...
 		public SysPermissionResponseDto toComponentName( String componentName){
 		 		this.componentName = componentName ; 
 		 		 return this ;
 		}
 		...
 		public SysPermissionResponseDto toRedirect( String redirect){
 		 		this.redirect = redirect ; 
 		 		 return this ;
 		}
 		...
 		public SysPermissionResponseDto toMenuType( int menuType){
 		 		this.menuType = menuType ; 
 		 		 return this ;
 		}
 		...
 		public SysPermissionResponseDto toPerms( String perms){
 		 		this.perms = perms ; 
 		 		 return this ;
 		}
 		...
 		public SysPermissionResponseDto toAlwaysShow( int alwaysShow){
 		 		this.alwaysShow = alwaysShow ; 
 		 		 return this ;
 		}
 		...
 		public SysPermissionResponseDto toIcon( String icon){
 		 		this.icon = icon ; 
 		 		 return this ;
 		}
 		...
 		public SysPermissionResponseDto toIsRoute( int isRoute){
 		 		this.isRoute = isRoute ; 
 		 		 return this ;
 		}
 		...
 		public SysPermissionResponseDto toIsLeaf( int isLeaf){
 		 		this.isLeaf = isLeaf ; 
 		 		 return this ;
 		}
 		...
 		public SysPermissionResponseDto toKeepAlive( int keepAlive){
 		 		this.keepAlive = keepAlive ; 
 		 		 return this ;
 		}
 		...
 		public SysPermissionResponseDto toHidden( int hidden){
 		 		this.hidden = hidden ; 
 		 		 return this ;
 		}
 		...
 		public SysPermissionResponseDto toDescription( String description){
 		 		this.description = description ; 
 		 		 return this ;
 		}
 		...
 		public SysPermissionResponseDto toDelFlag( int delFlag){
 		 		this.delFlag = delFlag ; 
 		 		 return this ;
 		}
 		...
 		public SysPermissionResponseDto toRuleFlag( int ruleFlag){
 		 		this.ruleFlag = ruleFlag ; 
 		 		 return this ;
 		}
